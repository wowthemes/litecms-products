<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.view') }}   {!! trans('product::product.name') !!}  [{!! $product->name !!}]  </h3>
...
$(document).ready(function(){
    ...
    $('#btn-edit').click(function(){
        $('#entry-product').load('{!!URL::to('admin/product/product')!!}/{!!$product->id!!}/edit');
    });
    ...
    $('#btn-delete').click(function(){
        swal({
            ...
            closeOnConfirm: false
                ...
                $.ajax({
                    url: '{!!URL::to('admin')!!}/product/product/{!!$product->id!!}',
                    type: 'DELETE',
                    processData: false,
                    contentType: false,
